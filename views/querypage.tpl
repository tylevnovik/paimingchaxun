...
*/
        (window.goog = window.goog || {}).inherits = function (a, c) {
            ...
            a.a = function (f, g, h) {
                for (var e = Array(arguments.length - 2), b = 2; b < arguments.length; b++) e[b - 2] = arguments[b];
...
*/
        /*
         ...
         rights grant found at http://polymer.github.io/PATENTS.txt
        */
        var p = window.Document.prototype.createElement, q = window.Document.prototype.createElementNS,
            ...
            ea = window.DocumentFragment.prototype.append, r = window.Node.prototype.cloneNode,
            t = window.Node.prototype.appendChild, u = window.Node.prototype.insertBefore,
            v = window.Node.prototype.removeChild, w = window.Node.prototype.replaceChild,
            x = Object.getOwnPropertyDescriptor(window.Node.prototype,
                "textContent"), z = window.Element.prototype.attachShadow,
            A = Object.getOwnPropertyDescriptor(window.Element.prototype, "innerHTML"),
            B = window.Element.prototype.getAttribute, C = window.Element.prototype.setAttribute,
            D = window.Element.prototype.removeAttribute, E = window.Element.prototype.getAttributeNS,
            F = window.Element.prototype.setAttributeNS, G = window.Element.prototype.removeAttributeNS,
            H = window.Element.prototype.insertAdjacentElement, fa = window.Element.prototype.insertAdjacentHTML,
        ...
        function U(a, b, c) {
            c = void 0 === c ? {} : c;
            var e = c.L, d = c.upgrade || function (g) {
                return S(a, g)
            }, f = [];
            O(a, b, function (g) {
                a.c && Q(a, g);
        ...
        function V(a) {
            var b = a.message, c = a.sourceURL || a.fileName || "", e = a.line || a.lineNumber || 0,
                d = a.column || a.columnNumber || 0, f = void 0;
        ...
        function X(a) {
            ...
            this.g = b;
            U(this.a, this.g);
            "loading" === this.g.readyState && (this.l = new MutationObserver(this.F.bind(this)), this.l.observe(this.g, {
                childList: !0,
                subtree: !0
            }))
        }
        ...
        n.J = function (a, b) {
            ...
            this.i.set(a, b);
            this.m.push(a);
            this.b || (this.b = !0, this.h(function () {
                return c.B()
            }))
        };
        ...
        function Ca(a) {
            ...
            function e(d,
                ...
                d.insertAdjacentHTML = function (h, k) {
                    ...
                    } else if ("afterbegin" === h) l = this.firstChild, f.call(this, h, k), g(this.firstChild, l); else if ("beforeend" === h) l = this.lastChild, f.call(this, h, k), g(l || this.firstChild, null); else if ("afterend" === h) l = this.nextSibling, f.call(this, h, k), g(this.nextSibling, l);
                    else throw new SyntaxError("The value provided (" + String(h) + ") is not one of 'beforebegin', 'afterbegin', 'beforeend', or 'afterend'.");
                }
            }

            z && (Element.prototype.attachShadow = function (d) {
                d = z.call(this, d);
            ...
            A && A.get ? b(Element.prototype, A) : I && I.get ? b(HTMLElement.prototype, I) : va(a, function (d) {
                b(d, {
        ...
        function Fa(a) {
            function b(c, e) {
                Object.defineProperty(c, "textContent", {
                    ...
                    get: e.get,
                    set: function (d) {
                        if (this.nodeType === Node.TEXT_NODE) e.set.call(this, d); else {
                            var f = void 0;
                            if (this.firstChild) {
            ...
            Node.prototype.removeChild = function (c) {
                var e =
                    c instanceof Element && J(c), d = v.call(this, c);
                e && T(a, c);
                return d
            };
            Node.prototype.replaceChild = function (c, e) {
                ...
                d = c instanceof Element && J(c);
                var f = w.call(this, c, e), g = J(this);
                g && T(a, e);
                d && T(a, c);
                g && R(a, c);
                return f
            };
            x && x.get ? b(Node.prototype, x) : ua(a, function (c) {
                b(c, {
                    enumerable: !0, configurable: !0, get: function () {
                        for (var e = [], d = this.firstChild; d; d = d.nextSibling) d.nodeType !== Node.COMMENT_NODE &&
                        e.push(d.textContent);
                        return e.join("")
                    }, set: function (e) {
...
*/
    ...
    <script data-source="gwdparticleeffects_min.js" data-version="4"
            data-exports-type="gwd-particleeffects">(function () {/*
...
*/
        ...
        var t = function (a, b, c) {
            ...
            a = parseFloat(a.getAttribute("time-limit"));
            isFinite(a) || (a = -1);
            return 0 < a ? a : -1
        };
        var v = /[^\d]+$/, w = function (a, b, c) {
            if (!a.hasAttribute(b)) return 0;
            b = a.getAttribute(b);
            if (isNaN(parseFloat(b))) c = 0; else {
                a = parseFloat(b);
                (b = (b = b.match(v)) && b[0] || null) && (b = b.trim());
                var d = a;
                "%" == b && (d = Number((a / 100 * c).toFixed(2)));
                c = d
            }
            return c
        };
        ...
        var y = function (a) {
            ...
            if (y(a)) return a;
            for (; a && 9 != a.nodeType;) if ((a = a.parentElement) && y(a)) return a;
            return null
        };
        ...
        var C = function (a, b, c) {
            if ("number" !== typeof a) {
                var d = typeof a, e = ["object" != d ? d : a ? Array.isArray(a) ? "array" : d : "null", a];
                d = "Assertion failed";
                b ? (d += ": " + b, e = Array.prototype.slice.call(arguments, 2)) : d += ": Expected number but got %s: %s.";
                throw new B("" + d, e || []);
            }
            return a
        };
        ...
        D.prototype = f(E.prototype);
        D.prototype.constructor = D;
        if (q) q(D, E); else for (var G in E) if ("prototype" != G) if (Object.defineProperties) {
            var H = Object.getOwnPropertyDescriptor(E, G);
            H && Object.defineProperty(D, G, H)
        } else D[G] = E[G];
        D.M = E.prototype;
        D.prototype.connectedCallback = function () {
            ...
            this.canvas || (this.canvas = this.ownerDocument.createElement("canvas"), this.appendChild(this.canvas));
            this.canvas.style.width = this.width + "px";
            this.canvas.style.height = this.height + "px";
            this.canvas.width = this.width * this.g;
            this.canvas.height = this.height * this.g;
            this.f = this.canvas.getContext("2d");
            this.H = this.hasAttribute("autoplay");
            null === this.o ? this.i = 1E3 * u(this) :
                this.D && this.play();
            setTimeout(function () {
                if (!a.gwdIsLoaded()) {
                    var b = z(a);
                    b ? b.gwdIsLoaded() && a.gwdLoad() : a.gwdLoad()
                }
            }, 0)
        };
        D.prototype.disconnectedCallback = function () {
            this.gwdIsLoaded() ? (this.D = 0 == this.c, this.pause(!1)) : I(this)
        };
        D.prototype.gwdLoad = function () {
            if (!this.gwdIsLoaded()) {
                ...
                for (var a = 0, b = 0; b < this.children.length; b++) {
                    ...
                    if (J(c)) c.gwdIsLoaded() || K(this, c), this.addEventListener("request-reload", this.I, !1); else if ("image" == c.getAttribute("assettype")) {
                        var d = c.getAttribute("source"), e = w(c, "left", this.width), h = w(c, "top", this.height),
                            k = w(c, "width", this.width), g = w(c, "height", this.height), F = t(c, "opacity", 100);
                        d = {
                            canvas: null,
                            src: d,
                            A: e * this.g,
                        ...
                        e = this.ownerDocument.createElement("img");
                        this.a.push(e);
                        e.addEventListener("load", this.h, !1);
                        e.addEventListener("error", this.h, !1);
                        this.l[a] = d;
                        c.setAttribute("image-index", a);
                        e.setAttribute("image-index", a++);
                        e.width = d.F;
                        e.height = d.v;
                        e.src = d.src
                    }
        ...
        D.prototype.gwdIsLoaded = function () {
            return this.j && 0 == this.a.length
        };
        var K = function (a, b) {
            -1 == a.a.indexOf(b) && (a.a.push(b), b.addEventListener("ready", a.s, !1));
            b.gwdLoad()
        }, I = function (a) {
            for (; a.a.length;) {
                var b = a.a.pop();
                b.removeEventListener("ready", a.s, !1);
                b.removeEventListener("load", a.h, !1);
                b.removeEventListener("error", a.h, !1)
            }
            a.j = !1;
            a.l.length = 0
        }, L = function (a) {
            a.j && 0 == a.a.length && (x("ready", a), a.H ? a.play(!0) : null != a.m && a.play(a.m), a.m = null)
        };
        D.prototype.J = function (a) {
            a = a.target;
            var b = this.a.indexOf(a);
            0 <= b && (this.a.splice(b, 1), a.removeEventListener("ready", this.s, !1), L(this))
        };
        ...
        D.prototype.L = function (a) {
            ...
            c.removeEventListener("load", this.h, !1);
            c.removeEventListener("error", this.h, !1);
            var d = this.a.indexOf(c);
            if (0 <= d) {
                var e = parseInt(c.getAttribute("image-index"), 10);
                if ("load" == a.type) {
                    var h = this.ownerDocument.createElement("canvas");
                    h.width = c.width;
                    h.height = c.height;
                    var k = this.l[e], g = h.getContext("2d");
                    g.globalAlpha = k.opacity;
                    setTimeout(function () {
                        d = b.a.indexOf(c);
                        b.a.splice(d, 1);
                ...
                } else this.a.splice(d,
                    1), L(this)
            }
        };
        var J = function (a) {
            return "gwd-particles" == a.tagName.toLowerCase()
        };
        D.prototype.play = function (a) {
            a = void 0 === a ? !0 : a;
            if (!this.gwdIsLoaded()) this.m = 0 != a; else if (0 != this.c) {
                null == this.o && (this.o = Date.now());
                if (2 == this.c) for (var b = 0; b < this.children.length; b++) {
                    var c = this.children[b].hasAttribute("autoplay");
                    J(this.children[b]) && c && this.children[b].play()
                }
                0 == a ? this.B(!1) : this.b = requestAnimationFrame(this.u);
                this.c = 0
            }
        };
        D.prototype.pause = function (a) {
            a = void 0 === a ? !0 : a;
            this.b && (cancelAnimationFrame(this.b), this.b = null, a && (this.i = -1), this.c = 1)
        };
        D.prototype.stop = function () {
            if (2 != this.c) {
                for (var a = 0; a < this.children.length; a++) J(this.children[a]) && this.children[a].stop();
                this.b && (cancelAnimationFrame(this.b), this.b = null, this.i = -1);
                this.c = 2;
        ...
        D.prototype.B = function (a) {
            if (0 != a && 0 < this.i && Date.now() - C(this.o) > this.i) this.pause(), x("timelimitreached", this); else {
                ...
                for (var b = 0; b < this.children.length; b++) {
                    var c = this.children[b];
                    c.hasAttribute("hidden") || (J(c) && c.gwdIsLoaded() ? c.updateAndDraw() : "image" == c.getAttribute("assettype") && (c = t(c, "image-index", -1), -1 != c && (c = this.l[c], c.canvas ? this.f.drawImage(c.canvas, c.A, c.C) : this.hasAttribute("data-gwd-node") && (this.f.strokeStyle = "#c0c0c0", this.f.lineWidth =
...
*/
        ...
        var w = function (a, b, d) {
            ...
            a = parseFloat(a.getAttribute(b));
            isFinite(a) || (a = d);
            return a
        }, C = function (a, b, d) {
            return a.hasAttribute(b) ? a.getAttribute(b) : d
        }, D = function (a, b, d) {
            switch (a.getAttribute(b)) {
                case "true":
                    return !0;
                case "false":
                    return !1;
        ...
        var na = /[^\d]+$/, G = function (a, b, d, c) {
            if (!a.hasAttribute(b)) return d;
            a = a.getAttribute(b);
            return isNaN(parseFloat(a)) ? d : E(a, c)
        }, E = function (a, b) {
            var d = parseFloat(a);
            (a = (a = a.match(na)) && a[0] || null) && (a = a.trim());
            var c = d;
            "%" == a && (c = Number((d / 100 * b).toFixed(2)));
            return c
        };
        var oa = /^#(?:[0-9a-f]{3}){1,2}$/i, pa = /#(.)(.)(.)/, H = [60, 6E3], I = function (a) {
                if (!oa.test(a)) return null;
                4 == a.length && (a = a.replace(pa, "#$1$1$2$2$3$3"));
                a = a.toLowerCase();
        ...
        var L = function (a, b, d) {
            ...
            for (b = a.length -
                1; 0 < b; --b) {
                var d = Math.floor(Math.random() * a.length), c = a[b];
                a[b] = a[d];
                a[d] = c
            }
            this.Wa = a.concat(a)
        }, Q = function (a, b, d, c) {
            var e = b & 255, f = d & 255, g = c & 255;
            b -= Math.floor(b);
            d -= Math.floor(d);
            c -= Math.floor(c);
            var l = M(b), h = M(d);
            a = a.Wa;
            return L(L(L(P(a[a[a[e] + f] + g], b, d, c), P(a[a[a[e + 1] + f] + g], b - 1, d, c), l), L(P(a[a[a[e] + f + 1] + g], b, d - 1, c), P(a[a[a[e + 1] + f + 1] + g], b - 1, d - 1, c), l), h), L(L(P(a[a[a[e] + f] + g + 1], b, d, c - 1), P(a[a[a[e + 1] + f] + g + 1], b - 1, d, c - 1), l), L(P(a[a[a[e] + f + 1] + g + 1], b, d - 1, c - 1), P(a[a[a[e + 1] + f + 1] + g + 1], b - 1, d - 1, c - 1), l), h), M(c))
        };
        var R = function (a) {
            this.Ia = a;
            this.Fa = [];
            this.length = this.la = 0
        };
        R.prototype.get = function (a) {
            return this.Fa[(a + this.la) % this.length]
        };
        R.prototype.push = function (a) {
            this.length < this.Ia && this.length++;
            this.Fa[this.la] = a;
            this.la = (this.la + 1) % this.Ia
        };
        var sa = 2 * Math.PI, S = function (a, b) {
            return a + Math.random() * (b - a)
        }, U = function (a, b) {
            this.h = [];
            this.b = b;
            this.c = a.getContext("2d");
            this.xa = window.devicePixelRatio;
            this.Ca = 1;
            this.Ga = [];
            this.Ha = [];
            if ("image" != this.b.pa.shape) a = null; else if ((a = this.b.pa.Va) && 0 != a.length) {
                b = [];
                this.Ca = this.b.oa.max * this.xa;
                for (var d = 0; d < a.length; d++) {
                    var c = a[d], e = document.createElement("canvas"), f = e.getContext("2d"),
                        g = this.Ca / Math.max(c.naturalWidth, c.naturalHeight), l = c.naturalWidth * g;
                    g *= c.naturalHeight;
                    e.width = Math.ceil(l);
                    e.height = Math.ceil(g);
                    f.drawImage(c, 0, 0, l, g);
                    b.push(e);
                    this.Ga.push(-l / 2);
                    this.Ha.push(-g / 2)
                }
                a = b
            } else this.b.pa.shape = "square", a = null;
            this.ya = a;
            this.ma = 0;
            this.Ta = 0 == this.b.g ? this.b.Aa : 1 / this.b.g;
            a = this.b.ca;
            this.wa = a.ha ? 0 : (a.ka - a.ta) * a.Ba;
            this.va = a.ha ? 0 : (a.ja - a.sa) * a.Ba;
            this.ua = a.ha ? 0 : (a.ia - a.ra) * a.Ba;
            this.Da = (a = this.b.Ka) ? new ra : null;
            this.Ea = a ? a.frequency : 1;
            this.$a = a ? a.Ya : 1;
            this.La = a && a.Za - 1 || 0;
            for (a = 0; a < this.b.Ja; a++) T(this)
        };
        U.prototype.reset = function () {
            for (var a = this.ma = this.h.length = 0; a < this.b.Ja; a++) T(this)
        };
        var V = function (a) {
            var b = S(a.b.na.Na, a.b.na.Ma), d = S(a.b.na.Pa, a.b.na.Oa), c = S(a.b.oa.min, a.b.oa.max),
                e = S(a.b.za.min, a.b.za.max), f = a.b.ca, g = f.ta, l = f.sa, h = f.ra;
            f.ha && (h = Math.random(), g = (1 - h) * f.ta + h * f.ka, l = (1 - h) * f.sa + h * f.ja, h = (1 - h) * f.ra + h * f.ia);
            var n = S(a.b.qa.j, a.b.qa.i);
            f = S(a.b.qa.Sa, a.b.qa.Ra);
            var y = n * Math.cos(f);
            n *= Math.sin(f);
            var x = -1;
            a.ya && (x = Math.floor(S(0, a.ya.length)));
            return {
                a: {positionX: b, positionY: d, size: c, Y: g, X: l, W: h, opacity: e, ea: !0, angle: f, fa: x},
                velocityX: y,
                velocityY: n,
                f: a.$a,
                ba: a.La ? new R(a.La) :
            ...
            for (var b = Date.now() / a.Ea, d = 0; d < a.h.length; d++) {
                var c = a.h[d], e = a;
                c.ba && c.ba.push({
                    positionX: c.a.positionX,
                    positionY: c.a.positionY,
                    size: c.a.size,
                    Y: c.a.Y,
                    X: c.a.X,
                    W: c.a.W,
                ...
                if (c.a.ea) {
                    c.a.positionX += c.velocityX;
                    c.a.positionY += c.velocityY;
                    if (e.Da && 0 < c.f) {
                        var f = c.a.positionX / e.Ea, g = c.a.positionY / e.Ea;
                        c.a.positionX += c.f * Q(e.Da, f, g, b);
                        c.a.positionY += c.f * Q(e.Da, b, f, g);
                        c.f += e.b.Ka.rate
                    }
                    c.a.size += e.b.oa.rate;
                    c.a.opacity = Math.min(1,
                        c.a.opacity + e.b.za.rate);
                    c.velocityX += e.b.acceleration.x;
                    c.velocityY += e.b.acceleration.y;
                    c.a.angle = Math.atan2(c.velocityY, c.velocityX);
                    f = e.b.ca;
                    f.ha || ((!e.wa || 1 < (f.ka - c.a.Y) / e.wa) && (!e.va || 1 < (f.ja - c.a.X) / e.va) && (!e.ua || 1 < (f.ia - c.a.W) / e.ua) ? (c.a.Y += e.wa, c.a.X += e.va, c.a.W += e.ua) : (c.a.Y = e.b.ca.ka, c.a.X = e.b.ca.ja, c.a.W = e.b.ca.ia))
                }
            ...
            if (b.ea) {
                a.c.fillStyle = "rgba(" + Math.round(b.Y) + ", " + Math.round(b.X) + ", " + Math.round(b.W) + ", " + b.opacity + ")";
                a.c.save();
                a.c.translate(b.positionX, b.positionY);
                var d = b.size / a.Ca;
                a.c.scale(d, d);
                switch (a.b.pa.shape) {
                    case "circle":
                    ...
                    case "teardrop":
                        a.c.beginPath();
                        a.c.moveTo(.08, -.5);
                        a.c.bezierCurveTo(.13, -.21, .16, .04, .3, .07);
                        a.c.bezierCurveTo(.44, .36, .13, .5, -.06, .5);
                        a.c.bezierCurveTo(-.49, .14, -.41, 0, .08, -.5);
                        a.c.fill();
                        break;
                    case "image":
                        a.c.globalAlpha = b.opacity;
                        a.c.drawImage(a.ya[b.fa], a.Ga[b.fa], a.Ha[b.fa]);
                        break;
                    default:
                        a.c.beginPath(), a.c.fillRect(-.5, -.5, 1, 1)
                }
                a.c.restore()
            }
        };
        ...
        var va = function (a) {
            ...
            if (va(a)) return a;
            for (; a && 9 != a.nodeType;) if ((a = a.parentElement) && va(a)) return a;
            return null
        }, xa = function (a) {
            return (a = C(a, "sprite-image-src", "")) ? a.split(",").map(function (b) {
                return b.trim()
            }) : []
        };
        var ya = {
            ...
            Cb: "speed-min",
            Db: "sprite-image-src",
            Eb: "turbulence-frequency",
            Fb: "turbulence-rate",
            Gb: "turbulence-strength",
            Hb: "turbulence-trail"
        }, za = [], Aa = 0, Ba;
        for (Ba in ya) za[Aa++] = ya[Ba];
        var W = function () {
            var a = HTMLElement.call(this) || this;
            a.M = null;
            a.$ = 0;
        ...
        W.prototype = aa(X.prototype);
        W.prototype.constructor = W;
        if (v) v(W, X); else for (var Y in X) if ("prototype" != Y) if (Object.defineProperties) {
            var Ca = Object.getOwnPropertyDescriptor(X, Y);
            Ca && Object.defineProperty(W, Y, Ca)
        } else W[Y] = X[Y];
        ...
        W.prototype.gwdLoad = function () {
            if (!this.M) {
                Z(this);
                var a = xa(this);
                if (this.$ = a.length) for (var b = 0; b < this.$; b++) {
                    var d = this.ownerDocument.createElement("img");
                    d.addEventListener("load", this.da, !1);
                    d.addEventListener("error", this.da, !1);
                    d.src = a[b];
                    this.Z.push(d)
                }
                0 === this.$ && Da(this)
        ...
        W.prototype.gwdIsLoaded = function () {
            return !!this.M
        };
        var Z = function (a) {
            for (; a.Z.length;) {
                var b = a.Z.pop();
                b.removeEventListener("load", a.da, !1);
                b.removeEventListener("error", a.da, !1)
            }
            a.$ = 0
        }, Da = function (a) {
            var b = a.getAttribute("preset-type"), d = a.Z.length ? a.Z : null;
            if (a.parentElement) {
                var c = a.parentElement.getElementsByTagName("canvas")[0];
                if (c) {
                    var e = a.parentElement.clientWidth, f = a.parentElement.clientHeight;
                    b = qa(b);
                    var g = E(b.F, e), l = E(b.D, e), h = E(b.H, f), n = E(b.G, f);
                    g = K(a, "emit-x-min", "emit-x-max", g, l, e);
                    h = K(a, "emit-y-min", "emit-y-max", h, n, f);
                    h = {
                        Na: g[0],
                        Ma: g[1], Pa: h[0], Oa: h[1]
                    };
                    n = b.I;
                    b.l && (n = Math.ceil(b.l * (h.Ma - h.Na) * (h.Oa - h.Pa)));
                    n = Math.min(A(a, "number", n), 1E3);
                    g = A(a, "emit-interval", b.g);
                    l = b.T;
                    var y = w(a, "skip-forward", l);
                    l = Math.round((0 <= y ? y : l) * Math.min(Math.max(n * g, H[0]), H[1]) / 100);
                    y = D(a, "loop", b.loop);
                    var x = J(a, "size-min", "size-max", b.R, b.P), z = B(a, "size-rate", b.S) / 60;
                    x = {min: x[0], max: x[1], rate: z};
                    z = J(a, "opacity-min", "opacity-max", b.K, b.J);
                    var t = B(a, "opacity-rate", b.L) / 60;
                    z = {min: z[0], max: z[1], rate: t};
                    t = C(a, "color1", b.A);
                    var r = C(a, "color2", b.B);
                    t = I(t);
                    r = I(r);
                    var m = D(a, "random-colors", b.N), p = B(a, "color-rate", b.C) / 60;
                    t = {ha: m, ta: t[0], sa: t[1], ra: t[2], ka: r[0], ja: r[1], ia: r[2], Ba: p};
                    r = J(a, "speed-min", "speed-max", b.j, b.i);
                    m = J(a, "angle-min", "angle-max", b.v, b.u);
                    m[0] = -m[0];
                    m[1] = -m[1];
                    r = {j: r[0], i: r[1], Sa: m[1] / 180 * Math.PI, Ra: m[0] / 180 * Math.PI};
                    m = B(a, "acceleration-x", b.o) / 60;
                    p = B(a, "acceleration-y", b.s) / 60;
                    m = {x: m, y: p};
                    p = C(a, "shape", b.shape);
                    d = {shape: p, Va: "image" == p ? d : null};
                    p = a.hasAttribute("turbulence-frequency");
                    var F = a.hasAttribute("turbulence-strength"),
                        N = a.hasAttribute("turbulence-rate"), O = a.hasAttribute("turbulence-trail");
                    b.O || p || F || N || O ? (p = B(a, "turbulence-frequency", b.m), F = B(a, "turbulence-strength", b.f), N = B(a, "turbulence-rate", b.U) / 60, O = Math.min(A(a, "turbulence-trail", b.V), 100), b = {
                        frequency: 0 < p ? p : b.m,
                        Ya: 0 < F ? F : b.f,
                        rate: N,
                        Za: O
        ...
        W.prototype.Ua = function (a) {
            var b = a.target;
            b.removeEventListener("load", this.da, !1);
            b.removeEventListener("error", this.da, !1);
            b = this.Z.indexOf(b);
            0 <= b && ("error" === a.type && this.Z.splice(b, 1), this.$--);
            0 === this.$ && Da(this)
        };
        W.prototype.updateAndDraw = function () {
            0 === this.ga && T(this.M);
            if (2 != this.ga) {
                var a = this.M;
                a.c.save();
                ...
                for (var b = 0; b < a.h.length; b++) {
                    var d = a.h[b];
                    if (d.ba) for (var c = 0; c < d.ba.length; c++) ta(a, d.ba.get(c));
                    ta(a, d.a)
                }
                a.c.restore()
            }
        ...
        W.prototype.reset = function () {
            Z(this);
            this.M = null;
            ua("request-reload", this)
        };
        ca.Object.defineProperties(W, {
            observedAttributes: {
                configurable: !0, enumerable: !0, get: function () {
                    return za
                }
        ...
        customElements.define("gwd-particles", W);
    }).call(this);
    </script>
