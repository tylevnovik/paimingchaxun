...
<head>
  <meta name="GCD" content="YTk3ODQ3ZWZhN2I4NzZmMzBkNTEwYjJl5562805b455584f66df94c539172aee1" />
  <meta charset="utf-8">
  <title>排名查询</title>
  ...
  <style type="text/css">
    ...
    .gwd-button-1gnh {
      ...
      -webkit-transform-style: preserve-3d;
      -moz-transform-style: preserve-3d;
      transform: translate3d(112px, 50px, 0px) rotateZ(9.99999deg);
      -webkit-transform: translate3d(112px, 50px, 0px) rotateZ(9.99999deg);
      -moz-transform: translate3d(112px, 50px, 0px) rotateZ(9.99999deg);
    }
    ...
    [data-gwd-group="Group1"] .gwd-grp-xuj0.gwd-select-15ih {
      position: absolute;
      width: 133.64px;
      height: 30.27px;
      left: 115.5px;
    ...
    [data-gwd-group="Group1"] .gwd-grp-xuj0.gwd-input-1hkx {
      position: absolute;
      width: 133.64px;
      height: 25.22px;
      left: 116.17px;
    ...
    [data-gwd-group="Group1"] .gwd-grp-xuj0.gwd-input-1qv2 {
      position: absolute;
      width: 133.64px;
      height: 25.22px;
      left: 115.5px;
    ...
    [data-gwd-group="Group1"] .gwd-grp-xuj0.gwd-input-1fr5 {
      position: absolute;
      width: 133.64px;
      height: 25.22px;
      left: 116.17px;
    ...
    [data-gwd-group="Group1"] .gwd-grp-xuj0.gwd-label-18ju {
      position: absolute;
      width: 100px;
      font-size: 22px;
      height: 25.66px;
    ...
    [data-gwd-group="Group1"] .gwd-grp-xuj0.gwd-label-a5t7 {
      position: absolute;
      width: 100px;
      font-size: 22px;
      height: 25.66px;
    ...
    [data-gwd-group="Group1"] .gwd-grp-xuj0.gwd-label-ts3j {
      position: absolute;
      width: 100px;
      font-size: 22px;
      height: 25.66px;
    ...
    [data-gwd-group="Group1"] .gwd-grp-xuj0.gwd-label-1xq4 {
      position: absolute;
      width: 100px;
      font-size: 22px;
      height: 25.66px;
...
*/
      ...
      d.connectedCallback = function () {
        var a = this; this.i = parseInt(this.getAttribute("data-gwd-width"), 10) || this.clientWidth; this.h = parseInt(this.getAttribute("data-gwd-height"), 10) || this.clientHeight; this.addEventListener("ready", this.j, !1); this.style.visibility = "hidden"; setTimeout(function () {
          a.a = Array.prototype.slice.call(a.querySelectorAll("*")).filter(function (c) { return "function" != typeof c.gwdLoad || "function" != typeof c.gwdIsLoaded || c.gwdIsLoaded() ? !1 : !0 }, a); a.g = !0; 0 < a.a.length ? a.f = !1 : u(a); a.b = !0; n("attached",
            a)
        }, 0)
      ...
      d.gwdDeactivate = function () {
        this.classList.add("gwd-inactive"); this.classList.remove("gwd-play-animation"); var a = Array.prototype.slice.call(this.querySelectorAll("*")); a.push(this); for (var c = 0; c < a.length; c++) {
          var b = a[c]; if (b.classList && (b.classList.remove("gwd-pause-animation"), b.hasAttribute("data-gwd-current-label"))) { var k = b.getAttribute("data-gwd-current-label"); b.classList.remove(k); b.removeAttribute("data-gwd-current-label") } delete b.gwdGotoCounters; b != this && "function" == typeof b.gwdDeactivate &&
            "function" == typeof b.gwdIsActive && 1 == b.gwdIsActive() && b.gwdDeactivate()
        } this.c = !1; n("pagedeactivated", this); n("detached", this)
      }; d.gwdIsActive = function () { return this.c }; d.gwdIsLoaded = function () { return this.g && 0 == this.a.length }; d.gwdLoad = function () { if (this.gwdIsLoaded()) u(this); else for (var a = this.a.length - 1; 0 <= a; a--)this.a[a].gwdLoad() }; d.m = function (a) { a = this.a.indexOf(a.target); -1 < a && (this.a.splice(a, 1), 0 == this.a.length && u(this)) };
      var u = function (a) { a.style.visibility = ""; a.f || (n("ready", a), n("pageload", a)); a.f = !0 }; p.prototype.gwdPresent = function () { n("pagepresenting", this); this.classList.add("gwd-play-animation") }; p.prototype.isPortrait = function () { return this.h >= this.i }; customElements.define("gwd-page", p);
    }).call(this);
  </script>
...
<body class="document-body">
  <form action="/" method="POST" enctype="multipart/form-data">
    <gwd-pagedeck class="gwd-page-container" id="pagedeck">
      <gwd-page id="page1" class="gwd-page-wrapper page1-content gwd-lightbox gwd-page-17r1" data-gwd-width="550px"
        data-gwd-height="530px">
        <div class="gwd-page-content page1-content gwd-div-1gqo">
          ...
          <div class="gwd-div-1otm" data-gwd-group="Group1">
            <select class="gwd-select-15ih gwd-grp-xuj0" data-gwd-name="item" name="item" data-gwd-grp-id="select_1">
              <option value="dayishangqimokaoshi" selected="" class="gwd-grp-xuj0">大一上期末考试</option>
            </select>
            <input type="text" class="gwd-input-1hkx gwd-grp-xuj0" placeholder="姓名" data-gwd-name="name" name="name"
              data-gwd-grp-id="text_1">
            <input type="text" class="gwd-input-1qv2 gwd-grp-xuj0" placeholder="学号" data-gwd-name="xduid" name="xduid"
              data-gwd-grp-id="text_2">
            <input type="text" class="gwd-input-1fr5 gwd-grp-xuj0" placeholder="身份证号" data-gwd-name="id" name="id"
              data-gwd-grp-id="text_3">
            <label class="gwd-label-18ju gwd-grp-xuj0" data-gwd-grp-id="label_6">查询类别</label>
            <label class="gwd-label-a5t7 gwd-grp-xuj0" data-gwd-grp-id="label_7">姓名</label>
            <label class="gwd-label-ts3j gwd-grp-xuj0" data-gwd-grp-id="label_8">学号</label>
            <label class="gwd-label-1xq4 gwd-grp-xuj0" data-gwd-grp-id="label_9">身份证号</label>
          </div>
        </div>
        <div
