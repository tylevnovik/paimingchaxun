...
<head>
    <meta name="GCD" content="YTk3ODQ3ZWZhN2I4NzZmMzBkNTEwYjJl28b039d31da919eb570428c14fc88872" />
    <meta charset="utf-8">
    <title>排名查询</title>
    ...
    <style type="text/css">
        ...
        gwd-grp-cyef.gwd-input-fk3t {
            width: 134px;
            left: 114px;
            top: 77px;
        }

        gwd-grp-cyef.gwd-label-bo8s {
            font-size: 20px;
            left: 0px;
            top: 80px;
        }

        gwd-grp-cyef.gwd-input-shhh {
            width: 134px;
            left: 114px;
            top: 117px;
        }

        gwd-grp-cyef.gwd-label-19j3 {
            font-size: 21px;
            width: 116px;
            left: 0px;
            top: 120px;
        ...
        gwd-grp-cyef.gwd-label-27js {
            font-size: 21px;
            top: 153px;
        }

        gwd-grp-cyef.gwd-input-dnuw {
            width: 134px;
            left: 114px;
            top: 37px;
        }

        gwd-grp-cyef.gwd-label-1u2o {
            width: 113px;
            top: 0px;
        }

        gwd-grp-cyef.gwd-select-xko4 {
            position: absolute;
            height: 24px;
            width: 134px;
            left: 117px;
        ...
        gwd-grp-cyef.gwd-label-1otp {
            left: 0px;
            top: 40px;
        }

        gwd-grp-cyef.gwd-label-o9fx {
            left: 0px;
        }
...
<body class="htmlNoPages">
    <form action="/" method="POST" enctype="multipart/form-data">
        <div data-gwd-group-def="Group1" data-gwd-group-class="gwd-grp-cyef" style="display: none;">
